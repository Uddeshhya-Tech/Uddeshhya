...
const AddProject = () => {
  ...
  const validateForm = () => {
    ...
    if (!content.trim()) {
      toast.error('Please enter project content');
      return false;
    }
    return true;
  };
  ...
  return (
    <div className="flex-1 p-4 sm:p-6 md:p-8 mb-16 mt-8 sm:mb-10 min-h-screen bg-gray-50 animate-fade-in">
      <div className="max-w-4xl mx-auto pt-4 sm:pt-6">
        <div className="flex items-center justify-between mb-6 animate-slide-down">
          <h2 className="text-2xl sm:text-3xl font-bold relative">
            Add New <span className="text-[#E74646]">Project</span>
          ...
          <div className="transition-all duration-300 hover:shadow-sm rounded-lg p-1">
            ...
            {imagePreview && (
              <div className="mb-4 transform transition-transform duration-500 hover:translate-y-1">
                <div className="w-40 h-40 sm:w-48 sm:h-48 border border-gray-200 rounded-lg overflow-hidden">
                  <img 
                    src={imagePreview} 
                    alt="Project preview" 
            ...
            {!imagePreview && imageFile && (
              <div className="mb-4 transform transition-transform duration-500 hover:translate-y-1">
                <div className="w-40 h-40 sm:w-48 sm:h-48 border border-gray-200 rounded-lg flex items-center justify-center text-gray-400 mb-2">
      ...
      <label className="block text-gray-700 mb-2 font-medium">Project Content</label>
      <div 
  ...
  style={{ maxHeight: "350px", overflow: "hidden" }} // Prevents overflow from the container
>
  <ReactQuill
    value={content}
    onChange={setContent}
            ...
            <div className="relative pt-1 animate-fade-in">
              <div className="flex items-center justify-between mb-1">
                <div className="text-sm font-medium text-gray-700">
                  {progress < 100 ? 'Adding project...' : 'Complete!'}
                </div>
