...
const UpdateSyllabus = () => {
  ...
  const handleUpdateSyllabus = async () => {
    ...
    try {
      ...
      toast.error(error.message || 'Failed to update syllabus. Please try again.');
    } finally {
      setLoading(false);
    }
  };
  ...
  if (initialLoading) {
    return (
      <div className="flex-1 p-4 sm:p-6 md:p-8 mb-16 mt-8 sm:mb-10 min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="animate-spin h-8 w-8 text-[#E74646]">
      ...
      <div className="max-w-4xl mx-auto pt-4 sm:pt-6">
        <div className="flex items-center justify-between mb-6 animate-slide-down">
          <h2 className="text-2xl sm:text-3xl font-bold relative">
            Update <span className="text-[#E74646]">Syllabus</span>
