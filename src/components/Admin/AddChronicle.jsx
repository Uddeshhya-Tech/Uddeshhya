...
const AddChronicle = () => {
  ...
  const handleAddChronicle = async () => {
    ...
    try {
      ...
      setProgress(100);
      toast.success('Chronicle added successfully!');
      navigate('/admin/dashboard');

    } catch (error) {
      console.error('Add chronicle error:', error);
      toast.error(error.message || 'Failed to add chronicle. Please try again.');
    } finally {
      setLoading(false);
      setProgress(0);
    }
      ...
      <div className="max-w-4xl mx-auto pt-4 sm:pt-6">
        <div className="flex items-center justify-between mb-6 animate-slide-down">
          <h2 className="text-2xl sm:text-3xl font-bold relative">
            Add New <span className="text-[#E74646]">Chronicle</span>
            ...
            <div className="relative pt-1 animate-fade-in">
              <div className="flex items-center justify-between mb-1">
                <div className="text-sm font-medium text-gray-700">
                  {progress < 100 ? 'Adding chronicle...' : 'Complete!'}
                </div>
